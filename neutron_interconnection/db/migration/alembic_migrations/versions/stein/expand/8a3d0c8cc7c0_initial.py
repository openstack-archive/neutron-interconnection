...
def upgrade():
    op.create_table(
        ...
        sa.Column('remote_keystone', sa.Text(), nullable=False),
        sa.Column('remote_region', sa.String(length=255), nullable=False),
        sa.Column('remote_interconnection_id', sa.String(length=36),
                  nullable=True),
        sa.Column('local_parameters', sa.String(length=255), nullable=True),
        sa.Column('remote_parameters', sa.String(length=255), nullable=True),
